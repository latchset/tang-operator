...
bundle. For example, in case latest version is **0.0.20**, the command to execute
will be:

```bash
$ operator-sdk run bundle quay.io/sarroutb/tang-operator-bundle:v0.0.20
INFO[0008] Successfully created registry pod: quay-io-sarroutb-tang-operator-bundle-v0-0-20
INFO[0009] Created CatalogSource: tang-operator-catalog
INFO[0009] OperatorGroup "operator-sdk-og" created
INFO[0009] Created Subscription: tang-operator-v0-0-20-sub
INFO[0011] Approved InstallPlan install-lqf9f for the Subscription: tang-operator-v0-0-20-sub
INFO[0011] Waiting for ClusterServiceVersion to reach 'Succeeded' phase
INFO[0012]   Waiting for ClusterServiceVersion "default/tang-operator.v0.0.20"
INFO[0018]   Found ClusterServiceVersion "default/tang-operator.v0.0.20" phase: Pending
INFO[0020]   Found ClusterServiceVersion "default/tang-operator.v0.0.20" phase: InstallReady
INFO[0021]   Found ClusterServiceVersion "default/tang-operator.v0.0.20" phase: Installing
INFO[0031]   Found ClusterServiceVersion "default/tang-operator.v0.0.20" phase: Succeeded
INFO[0031] OLM has successfully installed "tang-operator.v0.0.20"
```
...
```bash
$ operator-sdk run bundle --timeout 3m quay.io/sarroutb/tang-operator-bundle:v0.0.20
INFO[0008] Successfully created registry pod: quay-io-sarroutb-tang-operator-bundle-v0.0.20
...
INFO[0031] OLM has successfully installed "tang-operator.v0.0.20"
```
...
quay-io-tang-operator-bundle-v0.0.20                1/1   Running   0        90s
...
To summarize, taking into account that the last released version is **0.0.20**
compilation can be done with next command:

```bash
$ make docker-build docker-push IMG="quay.io/sarroutb/tang-operator:v0.0.20"
...
Successfully built 4a88ba8e6426
Successfully tagged sarroutb/tang-operator:v0.0.20
docker push sarroutb/tang-operator:v0.0.20
The push refers to repository [quay.io/sarroutb/tang-operator]
79109912085a: Pushed
417cb9b79ade: Layer already exists
v0.0.20: digest: sha256:c97bed08ab71556542602b008888bdf23ce4afd86228a07 size: 739
```
...
# - use the VERSION as arg of the bundle target (e.g make bundle VERSION=0.0.20)
# - use environment variables to overwrite this value (e.g export VERSION=0.0.20)
-VERSION ?= 0.0.16
+VERSION ?= 0.0.20
```
...
```bash
$ docker tag quay.io/sarroutb/tang-operator-bundle:v0.0.20 quay.io/sarroutb/tang-operator-bundle:latest
...
9ff8a4099c67: Pushed
417cb9b79ade: Layer already exists
v0.0.20: digest: sha256:01620ab19faae54fb382a2ff285f589cf0bde6e168f14f07 size: 739
```
...
```bash
$ make bundle IMG="quay.io/sarroutb/tang-operator:v0.0.20"
$ make bundle-build bundle-push BUNDLE_IMG="quay.io/sarroutb/tang-operator-bundle:v0.0.20"
...
docker push sarroutb/tang-operator-bundle:v0.0.20
The push refers to repository [quay.io/sarroutb/tang-operator-bundle]
02e3768cfc56: Pushed
df0c8060d328: Pushed
84774958bcf4: Pushed
v0.0.20: digest: sha256:925c2f844f941db2b53ce45cba9db7ee0be613321da8f0f05d size: 939
...
INFO[0001] subscription "tang-operator-v0.0.20-sub" deleted
INFO[0001] customresourcedefinition "tangservers.daemons.redhat.com" deleted
INFO[0002] clusterserviceversion "tang-operator.v0.0.20" deleted
...
Execution of operator-sdk scorecard tests are passing completely in version v0.0.20.
In order to execute these tests, run next command:

```bash
$ operator-sdk scorecard -w 60s quay.io/sarroutb/tang-operator-bundle:v0.0.20
...
Results:
